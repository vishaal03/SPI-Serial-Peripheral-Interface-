...
SPI_Periphery #(.LENGTH_SEND(LENGTH_SEND_P), .LENGTH_RECIEVED(LENGTH_RECIEVED_P), .LENGTH_COUNT(LENGTH_COUNT_P), .PAUSE(PAUSE)) SPI_P_4(.SCK(SCK),
                                .COPI(COPI),
                                .CIPO(CIPO),
                                .CS(CS_out[4]),
                                .data_send(data_send_p),
...
SPI_Periphery #(.LENGTH_SEND(LENGTH_SEND_P), .LENGTH_RECIEVED(LENGTH_RECIEVED_P), .LENGTH_COUNT(LENGTH_COUNT_P), .PAUSE(PAUSE)) SPI_P_5(.SCK(SCK),
                                .COPI(COPI),
                                .CIPO(CIPO),
                                .CS(CS_out[5]),
                                .data_send(data_send_p),
